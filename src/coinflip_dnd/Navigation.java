...
public class Navigate {
	...
	static String[] encounters = {
			"chest", "monster", "monsters", "nothing", "nothing", "nothing", "nothing",
	};
	...
	public static String checkWest() {
		if(inRoom != 0 && inRoom != 3 && inRoom != 6 
				&& (inRoom - 1) <= 8 && rooms[inRoom - 1] > 0) {
			return "west";
		}
		else {
			return "no way west";
	...
	public static String checkEast() {
		if((inRoom + 1) <= 8 && rooms[inRoom + 1] > 0 &&
				inRoom != 2 && inRoom != 5 && inRoom != 8) {
			return "east";
		}
		else {
			return "no way east";
